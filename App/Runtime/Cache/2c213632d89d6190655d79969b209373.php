...
<div id="tabbody-div">
	<form action="__SELF__" method="post" class="cf">
			 ...
			 <div class="list-div">	
				...
				<tr><th>全部<input type="checkbox" name="selectAll" value="all" /></th><th>标识号</th><th>客户名称</th><th>产品</th><th>销售</th><th>创建时间</th></tr>
<?php if(is_array($rubish)): $i = 0; $__LIST__ = $rubish;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rb): $mod = ($i % 2 );++$i;?><tr align="center"><td><input type="checkbox" name="orderids[]" value="<?php echo ($rb["id"]); ?>" /></td><td><?php echo ($rb["id"]); ?></td><td><?php echo ($rb["cusname"]); ?></td><td><?php echo ($rb["products_name"]); ?></td><td><?php echo ($rb["saleman"]); ?></td><td><?php echo (date('Y-m-d H:i:s',$rb["ctime"])); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</table>
</div>
...
<script language="javascript">
	$(function(){
		$('input[name="selectAll"]').click(function(){
			...
			$('input[name="orderids[]"]').attr('checked',sele);
