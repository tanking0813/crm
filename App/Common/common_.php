<?php
	...
	function saleman(){
		$User=D('user');
		$saleman=$User->Field('uid,uname')->where('department in ("2","8","9")')->select();
		if($saleman){
			if(Session('group')!='2'){
	...
	function get_cus_type($type){
		switch($type){
			case 0:
				return '<strong style="color:pink">潜在客户</strong>';
			case 1:
				return '<strong style="color:orange">意向客户</strong>';
			case 2:
				return '<strong style="color:green">成交客户</strong>';
			case 3:
				return '<strong style="color:red">重点客户</strong>';
			case 4:
				return '<strong style="color:#ccc">曾合作客户</strong>';
			case 5:
				return '<strong style="color:blue">潜在重点客户</strong>';
			case 7:
				return '<strong style="color:blue">无用客户</strong>';
